...
export default function Nav({ show, user }) {
          ...
          <div>
            ...
            >
              <svg
                ...
                stroke="currentColor"
                className={
                  pathname.includes("/patients") ? activeIcon : inactiveIcon
                }
              >
                <path
                  strokeLinecap="round"
            ...
            <Link
              href={"/doctors"}
              className={
                pathname.includes("/doctors") ? activeLink : inactiveLink
              }
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                ...
                stroke="currentColor"
                className={
                  pathname.includes("/doctors") ? activeIcon : inactiveIcon
                }
              >
                <path
                  strokeLinecap="round"
            ...
            >
              <svg
                ...
                stroke="currentColor"
                className={
                  pathname.includes("/appointments") ? activeIcon : inactiveIcon
                }
              >
                <path
                  strokeLinecap="round"
